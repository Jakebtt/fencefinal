...
export function Model({ textureUrl }) {
  const group = useRef();
  const { nodes, materials } = useGLTF('/Alumarch-fence/model25025.glb');
    ...
    <group ref={group} position={[0, -3, 0]} scale={[2, 2, 2]} dispose={null}>
      <group name="Scene">
        ...
        <group name="aEnd_Cap002" position={[-0.8, -1.054, -1.8]} rotation={[Math.PI / 2, 0, 0]}>
          <mesh name="End_Cap002" geometry={nodes.End_Cap002.geometry} material={materials['Material.004']} />
...
useGLTF.preload('/Alumarch-fence/model25025.glb')
